...
Menu.prototype.init = function() {
	this.bgSound = new MenuItem(100, 5, 0, this.top);

	/*for (var i = 1; i <= effects.length; i++) {
		this.leftHandMenuItems.push(new MenuItem(this.menuItemWidth, this.menuItemHeight, this.left +  this.menuItemWidth/2, this.top - this.menuItemHeight * i+1));
    this.rightHandMenuItems.push(new MenuItem(this.menuItemWidth, this.menuItemHeight, this.menuItemWidth/2 , this.top - this.menuItemHeight * i+1));
	}
	for (var i = 1; i <= instruments.length; i++) {
		this.leftHandMenuItems.push(new MenuItem(this.menuItemWidth, this.menuItemHeight, this.left + 3*this.menuItemWidth/2, this.top - this.menuItemHeight * i+1));
    this.rightHandMenuItems.push(new MenuItem(this.menuItemWidth, this.menuItemHeight, 3/2 * this.menuItemWidth, this.top - this.menuItemHeight * i+1));
	}*/
};
